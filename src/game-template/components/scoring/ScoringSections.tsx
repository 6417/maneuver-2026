...
export function ScoringSections({
  ...
  const actionBalls1Count = actions.filter(a => a.actionType === 'actionBalls1Count').length;
  const actionBalls2Count = actions.filter(a => a.actionType === 'actionBalls2Count').length;
  const actionBalls4Count = actions.filter(a => a.actionType === 'actionBalls4Count').length;
  const actionBalls8Count = actions.filter(a => a.actionType === 'actionBalls8Count').length;
